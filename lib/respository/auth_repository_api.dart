  ...
  Future<int> login({required String email, required String password}) async {
    ...
    try {
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        await storage.write(key: 'id', value: id.toString());  // Save ID as string
    ...
    try {
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        // await storage.write(key: 'profile_image', value: profile_image);
          ...
          print(
              "::::::::::>> User sign up successfull:   ${res.statusCode}  ${res
                  .body}");
          return 1;
        }
        else if (res.statusCode == 422) {
          print(
              "::::::::::>> Account with email already exists    ${res
                  .statusCode}  ${res.body}");
          return -1;
        } else {
          print(
              "::::::::::>> Failed to signup    ${res.statusCode}  ${res
                  .body}");
          return 1;
        }
    }
